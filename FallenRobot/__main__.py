...
buttons = [
    [
        InlineKeyboardButton(
            ...
            url=f"https://t.me/SFW_ManagerBot?startgroup=true",
        ),
    ],
    [
    ...
    [
        ...
        InlineKeyboardButton(text="✨ sᴜᴩᴩᴏʀᴛ ✨", url=f"https://t.me/SFW_BotCore"),
    ],
    [
        InlineKeyboardButton(text="🥀 ᴅᴇᴠᴇʟᴏᴩᴇʀ 🥀", url=f"tg://user?id=5397621246"),
